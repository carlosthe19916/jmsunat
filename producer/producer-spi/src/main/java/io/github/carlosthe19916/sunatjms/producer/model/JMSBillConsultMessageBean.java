...
public class JMSBillConsultMessageBean {
    ...
    private JMSBillConsultMessageBean(Builder builder) {
    ...
    public static class Builder {
        ...
        public JMSBillConsultMessageBean build() {
            return new JMSBillConsultMessageBean(this);
        }
    }
