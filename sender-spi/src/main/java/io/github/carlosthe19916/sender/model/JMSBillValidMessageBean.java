...
public class JMSBillValidMessageBean {
    ...
    private JMSBillValidMessageBean(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder importeTotal(Double importeTotal) {
        ...
        public JMSBillValidMessageBean build() {
            return new JMSBillValidMessageBean(this);
        }
    }
