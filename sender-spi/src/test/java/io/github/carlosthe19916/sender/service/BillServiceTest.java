...
public class BillServiceTest {
    ...
    public static Archive createDeployment() throws Exception {
        ...
        deployment.addClasses(BillService.class, DefaultBillService.class);
        deployment.addClasses(SenderConfig.class, BillBean.class);
    ...
    @Before
    public void before() {
        config = new SenderConfig.Builder()
                .endpoint("myEndpoint")
                .username("myUsername")
                .password("myPassword")
                .build();
